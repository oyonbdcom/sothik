...
const DoctorFilterForm = () => {
  ...
  return (
    <div className="w-full   bg-white border border-slate-200 rounded-2xl shadow-sm py-4">
      {/* Mobile Toggle Button */}
      <button
        onClick={() => setIsMobileOpen(!isMobileOpen)}
        className="lg:hidden w-full flex items-center justify-between px-4  active:scale-[0.98] transition-all"
      >
      ...
      {/* Filter Container */}
      <div
        className={` px-4  ${isMobileOpen ? "block mt-4  " : "hidden"} lg:block`}
      >
        <div className="  relative">
          ...
          <div className="flex items-center justify-between mt-3">
            <h2 className="hidden   lg:flex items-center gap-2 font-black text-slate-800 uppercase tracking-tight text-xs">
