"use client";
// import BestDoctors from "@/components/doctors/best-doctors";
          ...
          <div className="container mx-auto px-6">
            <div className="flex flex-col md:flex-row items-center gap-12">
              ...
              >
                <div className="md:w-1/2">
                  ...
                  <p className="text-lg text-default-600 mb-4">
                    ...
                    records, we provide one seamless platform to manage
                    everything in a smarter way.
                  </p>
              ...
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <div className="md:w-1/2 bg-default-100 rounded-xl overflow-hidden">
                  <Image
        ...
        <section className="py-20 bg-background/10">
          <div className="container mx-auto px-6">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-3xl font-bold text-center text-default-800 mb-16">
                What We Offer
              </h2>
            </motion.div>
